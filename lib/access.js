...
export const moduleAccess = {
  ...
  '/enterprise-dashboard': ['Admin','Manager','Editor','Viewer'],
  ...
  '/ppe-management': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/p3k-management': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/p2k3l-management': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/safety-violation': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/loto-management': ['Admin','Manager','Editor','Contributor','Viewer'],
  ...
  '/qr-inspection': ['Admin','Manager','Editor','Contributor','Viewer'],
  ...
  '/contractor-hse': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/man-hours': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/asset-integrity': ['Admin','Manager','Editor','Viewer'],
  '/asset-integrity-analytics': ['Admin','Manager','Editor','Viewer'],
  '/predictive-inspection': ['Admin','Manager','Editor','Viewer'],
  '/qr-labels': ['Admin','Manager','Editor','Viewer'],
  '/regulatory-compliance': ['Admin','Manager','Editor','Viewer'],
  '/environmental-esg': ['Admin','Manager','Editor','Viewer'],
  '/esg-dashboard': ['Admin','Manager','Editor','Viewer'],
  '/gis-map': ['Admin','Manager','Editor','Viewer'],
  '/audit-management': ['Admin','Manager','Editor','Viewer'],
  '/document-evidence': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/reminder-engine': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/enterprise-alerts': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/risk-intelligence': ['Admin','Manager','Editor','Contributor','Viewer'],
  '/ai-prediction': ['Admin','Manager','Editor','Viewer'],
  '/ai-recommendation': ['Admin','Manager','Editor','Viewer'],
  '/ai-compliance-prediction': ['Admin','Manager','Editor','Viewer'],
