...
import {
  ...
  GraduationCap, LayoutDashboard, Leaf, ListTodo, LogIn, LogOut, Menu, Network, QrCode, ScanLine, Search,
...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/environmental-esg', label: 'Environmental & ESG Dashboard', icon: Leaf },
