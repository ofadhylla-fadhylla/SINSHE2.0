...
import {
  AlertTriangle, Bell, CheckCircle2, Clock3, Download, ExternalLink,
  RefreshCw, Search, TimerReset, Undo2
} from 'lucide-react'
...
import styles from './reminder-engine.module.css'

const ACTION_KEY='sinshe-reminder-actions'
const SOURCES=[
  {key:'corrective',label:'Corrective Action',table:'corrective_actions',local:'sinshe-corrective-actions',route:'/corrective-action'},
  {key:'ptw',label:'Permit to Work',table:'permits',local:'sinshe-permits',route:'/permit-to-work'},
  {key:'asset',label:'Asset Integrity',table:'assets',local:'sinshe-assets',route:'/asset-integrity'},
  {key:'compliance',label:'Regulatory Compliance',table:'regulatory_obligations',local:'sinshe-regulatory-obligations',route:'/regulatory-compliance'},
  {key:'learning',label:'Learning & Competency',table:'learning_records',local:'sinshe-learning-records',route:'/learning-competency'},
